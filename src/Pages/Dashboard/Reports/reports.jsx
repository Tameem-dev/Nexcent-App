...
const navItems = [
  ...
  { icon: <MdBarChart size={16} />, label: "Reports", active: true, path: "/reports" },
...
const reportCategories = [
  { id: 1, name: "All Reports", count: 24, active: true },
        ...
        <div className={styles.header}>
          ...
          <div className={styles.headerRight}>
            ...
            <button className={styles.exportBtn}>
              <MdFileDownload size={16} /> Export All
            </button>
          </div>
        </div>
        ...
        <div className={styles.reportsList}>
          {filteredReports.map((report) => (
            <div key={report.id} className={styles.reportItem}>
              <div className={styles.reportIcon} style={{ backgroundColor: `${report.color}15`, color: report.color }}>
                {report.icon}
              </div>
              <div className={styles.reportInfo}>
                ...
                <div className={styles.reportMeta}>
                  ...
                  <span className={styles.reportDate}>
                    <MdDateRange size={14} /> {report.date}
                  </span>
